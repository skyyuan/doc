                ...
                <div class="tab-wrap">
                    <div class="tab-item manual-catalog">
                        <div class="catalog-list read-book-preview" id="sidebar">
                            <ul><li id="1" class="jstree-open"><a href="#" title="项目简介" class="jstree-clicked">项目简介</a></li><li id="8"><a href="# title="使用手册">使用手册</a><ul><li id="135"><a href="#" title="SmartWiki依赖扩展">SmartWiki依赖扩展</a></li><li id="9"><a href="#" title="SmartWiki安装与部署">SmartWiki安装与部署</a></li><li id="10"><a href="#" title="密码找回与邮件配置">密码找回与邮件配置</a></li><li id="21"><a href="#" title="Artisan命令安装SmartWiki">Artisan命令安装SmartWiki</a></li><li id="22"><a href="#" title="在Docker中使用SmartWiki">在Docker中使用SmartWiki</a></li><li id="105"><a href="#" title="图片和附件配置">图片和附件配置</a></li><li id="133"><a href="#" title="查看SmartWiki版本">查看SmartWiki版本</a></li><li id="134"><a href="#" title="使用phpStudy安装SmartWiki">使用phpStudy安装SmartWiki</a></li><li id="138"><a href="https://wiki.iminho.me/docs/show/138" title="接口管理和测试工具">接口管理和测试工具</a></li></ul></li><li id="90"><a href="https://wiki.iminho.me/docs/show/90" title="PHP环境搭建">PHP环境搭建</a><ul><li id="18"><a href="https://wiki.iminho.me/docs/show/18" title="Linux命令行下Nginx+PHP-FPM安装与配置">Linux命令行下Nginx+PHP-FPM安装与配置</a></li><li id="17"><a href="https://wiki.iminho.me/docs/show/17" title="Linux命令行下Apache+PHP安装与配置">Linux命令行下Apache+PHP安装与配置</a></li><li id="91"><a href="https://wiki.iminho.me/docs/show/91" title="Linux下使用XAMPP搭建PHP环境">Linux下使用XAMPP搭建PHP环境</a></li><li id="92"><a href="https://wiki.iminho.me/docs/show/92" title="Windows下使用phpStudy搭建php环境">Windows下使用phpStudy搭建php环境</a></li></ul></li><li id="4"><a href="https://wiki.iminho.me/docs/show/4" title="Composer安装">Composer安装</a></li><li id="5"><a href="https://wiki.iminho.me/docs/show/5" title="更新日志">更新日志</a></li><li id="6"><a href="https://wiki.iminho.me/docs/show/6" title="常见问题">常见问题</a></li></ul>
                        </div>
