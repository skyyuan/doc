                    ...
                    <div class="book-list">
                        ...
                        <div class="list-item" v-for="item in lists">
                            <div class="book-title">
                                <div class="pull-left">
                                    <a :href="'{{.BaseUrl}}/book/' + item.identify + '/setting'" title="项目概要" data-toggle="tooltip">
                                ...
                                <div class="pull-right">
                                    <div class="btn-group">
                                        <a  :href="'{{.BaseUrl}}/book/' + item.identify + '/setting'" class="btn btn-default">设置</a>
                            ...
                            <div class="desc-text">
                                    ...
                                    <template v-else="">
                                        <a :href="'{{.BaseUrl}}/book/' + item.identify + '/setting'" title="项目概要" style="font-size: 12px;">
                                        ${item.description}
                                        </a>
                                    </template>
                            </div>
